...
<head>
	...
	<meta charset="utf-8">
	<title>Shantanu Textiles - Admin Panel - <?php echo $name; ?> Edit </title>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> <?php echo $name; ?> Edit </h2>
					</div>
					<div class="box-content">
						<form  action="update-product.php" method="POST" class="form-horizontal">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" style="width:350px;" name="name" id="inputWarning" value="<?php echo $name; ?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Sequence No.</label>
							  <div class="controls">
								<input type="text" style="width:350px;" name="sequence" id="inputWarning" value="<?php echo $sequence; ?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="textarea2">Product Content</label>
							  <div class="controls">
